...
- The Bertrand equilibrium prices do not correspond to the monopoly prices
  - As in the Cournot model, independent profit-maximizing oligopolists will typically not attain the outcome that a profit-maximizing monopolist would, because neither firm takes into account the adverse effect that a price cut or the beneficial effect that a price increase would have on its rival.
...
- If the total number of units purchased in equilibrium is about the same in Markets A and B, Market B would have more firms than Market A because each firm in market B sells a smaller quantity than each firm in market A.
