...
[Last line follows because price elasticity of demand $\epsilon_{Q,P}<0$]{.aside}
...
:::
::: {.column width="70%"}
![It is cheaper for 1 firm to produce 9 than for two to produce 4.5](figures/natural_mono.png)
:::
::::
