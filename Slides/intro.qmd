...
- What happens if prices increase? What happens if the cost function increases?

## Recap

- Economics is the science that studies the allocation of scarce resources to satisfy competing uses

- What sets economics apart from other Social Sciences is its approach: Maximizing behavior, market equilibrium, and stable preferences (profit functions)

- Microeconomics studies the behavior of individual decision makers


## Recap

- Economics use models, simplified descriptions of reality designed to yield predictions about economic phenomena

- The three analytical tools we use are 1) Constrained optimization, 2) Equilibrium analyses, and 3) Comparative statics
