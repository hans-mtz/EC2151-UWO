...
\addplot[color=gray, dashed] coordinates {(2,0) (2,13)};% node[pos=0.9, anchor=east] {$Q_1$};
...
\node[label={270:{\( Q_1 \)}},circle,fill,inner sep=2pt] at (axis cs:2,0) {};
% on the graph
\node[circle,fill,inner sep=2pt] at (axis cs:2,5) {};
